...
namespace Openize.Slides.Facade
{
    ...
    public class AnimateFacade
    {
        ...
        public Timing animate()
        {
            ...
            {
                case "FloatIn":
                    timing = GenerateFloatInTiming(ShapeId, 1000);
                    break;
                case "FlyIn":
                    timing = GenerateFlyInTiming(ShapeId, 1000);
                    break;
                case "Zoom":
                    timing = GenerateZoomTiming(ShapeId, 1000);
                    break;
                case "Spin":
                    timing = GenerateSpinTiming(ShapeId, 1000);
                    break;
                default:
                    timing = new Timing();
                    break;
        ...
        public Timing GenerateFlyInTiming(String shapeId, int duration)
        {
                ...
                CommonTimeNode commonTimeNode8 = new CommonTimeNode() { Id = (UInt32Value)8U, Duration = "500", Fill = TimeNodeFillValues.Hold };
